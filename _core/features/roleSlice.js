...
export const getRoles = createAsyncThunk(
  "role/getRoles",
  ({ token, page = 0, limit = 10000, logoutHandler }) =>
...
// Delete Role
export const deleteRole = createAsyncThunk("role/deleteRole", ({ id, token }) =>
  makeRequest("delete", `/api/role/${id}`, {
    token,
...
export const editRole = createAsyncThunk(
  "role/editRole",
  ({ id, token, data }) =>
    makeRequest("put", `/api/role/${id}`, {
      data,
      token,
      successMessage:
        "Role updated successfully, Changes will relfect after login",
